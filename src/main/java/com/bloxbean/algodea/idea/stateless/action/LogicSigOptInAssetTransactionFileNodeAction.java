...
public class LogicSigOptInAssetTransactionFileNodeAction extends LogicSigOptInAssetTransactionAction {
    private final static Logger LOG = Logger.getInstance(LogicSigOptInAssetTransactionFileNodeAction.class);
