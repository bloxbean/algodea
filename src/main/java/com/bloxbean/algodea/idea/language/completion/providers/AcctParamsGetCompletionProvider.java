...
import static com.bloxbean.algodea.idea.language.completion.metadata.atoms.TEALKeywords.ACCT_PARAMS_GET_FIELDS_ELEMENTS_MAP;
import static com.intellij.patterns.PlatformPatterns.psiElement;

public class AcctParamsGetCompletionProvider extends BaseCompletionProvider{
    public static final ElementPattern<PsiElement> PATTERN = psiElement()
            .afterLeaf(psiElement(TEALTypes.STATEACCESS_OP)
                    .withParent(psiElement(TEALTypes.ACCT_PARAMS_GET_OP)))
    ...
    protected void addCompletions(@NotNull CompletionParameters parameters, @NotNull ProcessingContext context, @NotNull CompletionResultSet result) {
        ...
        selectFieldsByVersion(ACCT_PARAMS_GET_FIELDS_ELEMENTS_MAP, result, version);
