...
import static com.bloxbean.algodea.idea.codegen.service.TransactionPropConstant.*;

public interface SdkCodeGenerator {

    List<FileContent> generateCode(Transaction transaction, TxnType type, Account signer, NodeInfo nodeInfo, String targetFileName, LogListener logListener) throws CodeGenerationException;

    default String mergeContent(String templateName, Map<String, String> props) {
    ...
    default Map<String, String> getProperties(Transaction txn, Account signer, NodeInfo nodeInfo, LogListener logListener) {
