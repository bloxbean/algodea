...
public class FreezeAssetAction extends AlgoBaseAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        AssetConfigurationDialog dialog = new AssetConfigurationDialog(project, AssetActionType.FREEZE, getTitle());
        ...
        try {
            ...
            Task.Backgroundable task = new Task.Backgroundable(project, getTxnCommand()) {
                ...
                public void run(@NotNull ProgressIndicator indicator) {
                    ...
                    try {
                        boolean status = assetTransactionService.freezeAsset(managerAccount, finalAssetTxnPrameters, txnDetailsParameters);
