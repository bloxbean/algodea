...
public class DestroyAssetAction extends AlgoBaseAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        AssetConfigurationDialog dialog = new AssetConfigurationDialog(project, AssetActionType.DESTROY, getTitle());
