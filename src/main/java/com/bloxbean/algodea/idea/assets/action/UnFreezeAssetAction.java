...
public class UnFreezeAssetAction extends AlgoBaseAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        AssetConfigurationDialog dialog = new AssetConfigurationDialog(project, AssetActionType.UNFREEZE, getTitle());
        ...
        try {
            ...
            Task.Backgroundable task = new Task.Backgroundable(project, getTxnCommand()) {
                ...
                public void run(@NotNull ProgressIndicator indicator) {
                    ...
                    try {
                        boolean status = assetTransactionService.unfreezeAsset(managerAccount, finalAssetTxnPrameters, txnDetailsParameters);
