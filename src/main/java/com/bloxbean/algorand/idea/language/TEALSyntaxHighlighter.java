...
public class TEALSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(TEALTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(TEALTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(TEALTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(TEALTypes.COMMENT)) {
            return COMMENT_KEYS;
