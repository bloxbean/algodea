...
public class TEALGlobalOpCodeImpl extends ASTWrapperPsiElement implements TEALGlobalOpCode {

  public TEALGlobalOpCodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGlobalOpCode(this);
  }
