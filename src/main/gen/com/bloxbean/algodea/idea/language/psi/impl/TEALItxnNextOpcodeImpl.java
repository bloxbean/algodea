...
public class TEALItxnNextOpcodeImpl extends ASTWrapperPsiElement implements TEALItxnNextOpcode {

  public TEALItxnNextOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnNextOpcode(this);
  }
