...
public class TEALMinBalanceOpcodeImpl extends ASTWrapperPsiElement implements TEALMinBalanceOpcode {

  public TEALMinBalanceOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitMinBalanceOpcode(this);
  }
