...
public class TEALBGreaterThanOpcodeImpl extends ASTWrapperPsiElement implements TEALBGreaterThanOpcode {

  public TEALBGreaterThanOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBGreaterThanOpcode(this);
  }
