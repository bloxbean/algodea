...
public class TEALBZeroOpcodeImpl extends ASTWrapperPsiElement implements TEALBZeroOpcode {

  public TEALBZeroOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBZeroOpcode(this);
  }
