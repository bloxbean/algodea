...
public class TEALLoadsOpcodeImpl extends ASTWrapperPsiElement implements TEALLoadsOpcode {

  public TEALLoadsOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitLoadsOpcode(this);
  }
