...
public class TEALRetsubOpcodeImpl extends ASTWrapperPsiElement implements TEALRetsubOpcode {

  public TEALRetsubOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitRetsubOpcode(this);
  }
