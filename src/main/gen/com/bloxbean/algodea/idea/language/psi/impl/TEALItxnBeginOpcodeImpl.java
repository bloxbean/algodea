...
public class TEALItxnBeginOpcodeImpl extends ASTWrapperPsiElement implements TEALItxnBeginOpcode {

  public TEALItxnBeginOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnBeginOpcode(this);
  }
