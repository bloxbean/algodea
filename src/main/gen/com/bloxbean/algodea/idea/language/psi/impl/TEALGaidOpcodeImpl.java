...
public class TEALGaidOpcodeImpl extends ASTWrapperPsiElement implements TEALGaidOpcode {

  public TEALGaidOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGaidOpcode(this);
  }
