...
public class TEALLogOpcodeImpl extends ASTWrapperPsiElement implements TEALLogOpcode {

  public TEALLogOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitLogOpcode(this);
  }
