...
public class TEALBMinusOpcodeImpl extends ASTWrapperPsiElement implements TEALBMinusOpcode {

  public TEALBMinusOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBMinusOpcode(this);
  }
