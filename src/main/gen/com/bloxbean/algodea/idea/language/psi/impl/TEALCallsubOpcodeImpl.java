...
public class TEALCallsubOpcodeImpl extends ASTWrapperPsiElement implements TEALCallsubOpcode {

  public TEALCallsubOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitCallsubOpcode(this);
  }
