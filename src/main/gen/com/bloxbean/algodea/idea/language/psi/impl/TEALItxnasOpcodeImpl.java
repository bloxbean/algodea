...
public class TEALItxnasOpcodeImpl extends ASTWrapperPsiElement implements TEALItxnasOpcode {

  public TEALItxnasOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnasOpcode(this);
  }
