...
public class TEALGtxnasOpcodeImpl extends ASTWrapperPsiElement implements TEALGtxnasOpcode {

  public TEALGtxnasOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnasOpcode(this);
  }
