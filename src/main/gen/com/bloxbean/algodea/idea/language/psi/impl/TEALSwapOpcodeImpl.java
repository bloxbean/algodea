...
public class TEALSwapOpcodeImpl extends ASTWrapperPsiElement implements TEALSwapOpcode {

  public TEALSwapOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitSwapOpcode(this);
  }
