...
public class TEALAcctParamsGetOpImpl extends ASTWrapperPsiElement implements TEALAcctParamsGetOp {

  public TEALAcctParamsGetOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitAcctParamsGetOp(this);
  }
