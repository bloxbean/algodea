...
public class TEALExpOpcodeImpl extends ASTWrapperPsiElement implements TEALExpOpcode {

  public TEALExpOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExpOpcode(this);
  }
