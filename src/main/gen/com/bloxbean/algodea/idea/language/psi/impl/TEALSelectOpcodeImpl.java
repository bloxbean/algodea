...
public class TEALSelectOpcodeImpl extends ASTWrapperPsiElement implements TEALSelectOpcode {

  public TEALSelectOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitSelectOpcode(this);
  }
