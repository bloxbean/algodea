...
public class TEALBBitwiseOrOpcodeImpl extends ASTWrapperPsiElement implements TEALBBitwiseOrOpcode {

  public TEALBBitwiseOrOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBBitwiseOrOpcode(this);
  }
