...
public class TEALEcdsaPkDecompressOpcodeImpl extends ASTWrapperPsiElement implements TEALEcdsaPkDecompressOpcode {

  public TEALEcdsaPkDecompressOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitEcdsaPkDecompressOpcode(this);
  }
