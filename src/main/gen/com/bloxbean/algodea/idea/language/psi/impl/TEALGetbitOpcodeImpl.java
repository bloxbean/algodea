...
public class TEALGetbitOpcodeImpl extends ASTWrapperPsiElement implements TEALGetbitOpcode {

  public TEALGetbitOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGetbitOpcode(this);
  }
