...
public class TEALGtxnsLoadingOperationImpl extends ASTWrapperPsiElement implements TEALGtxnsLoadingOperation {

  public TEALGtxnsLoadingOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnsLoadingOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALGtxnsOpcode getGtxnsOpcode() {
    return findNotNullChildByClass(TEALGtxnsOpcode.class);
  }
