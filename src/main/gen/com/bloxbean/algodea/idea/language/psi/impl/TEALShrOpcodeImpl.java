...
public class TEALShrOpcodeImpl extends ASTWrapperPsiElement implements TEALShrOpcode {

  public TEALShrOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitShrOpcode(this);
  }
