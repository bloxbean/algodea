...
public class TEALAssetHoldingGetOPImpl extends ASTWrapperPsiElement implements TEALAssetHoldingGetOP {

  public TEALAssetHoldingGetOPImpl(@NotNull ASTNode node) {
    super(node);
  }
