...
public class TEALGaidsOpcodeImpl extends ASTWrapperPsiElement implements TEALGaidsOpcode {

  public TEALGaidsOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGaidsOpcode(this);
  }
