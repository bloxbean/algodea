...
public class TEALAssertOpcodeImpl extends ASTWrapperPsiElement implements TEALAssertOpcode {

  public TEALAssertOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitAssertOpcode(this);
  }
