...
public class TEALCallSubroutineOperationImpl extends ASTWrapperPsiElement implements TEALCallSubroutineOperation {

  public TEALCallSubroutineOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitCallSubroutineOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALCallsubOpcode getCallsubOpcode() {
    return findNotNullChildByClass(TEALCallsubOpcode.class);
  }
