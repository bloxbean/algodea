...
public class TEALAppParamsGetOpImpl extends ASTWrapperPsiElement implements TEALAppParamsGetOp {

  public TEALAppParamsGetOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitAppParamsGetOp(this);
  }
