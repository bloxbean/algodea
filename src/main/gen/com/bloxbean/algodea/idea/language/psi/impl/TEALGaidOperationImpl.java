...
public class TEALGaidOperationImpl extends ASTWrapperPsiElement implements TEALGaidOperation {

  public TEALGaidOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGaidOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALGaidOpcode getGaidOpcode() {
    return findNotNullChildByClass(TEALGaidOpcode.class);
  }
