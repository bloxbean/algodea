...
public class TEALBModuloOpcodeImpl extends ASTWrapperPsiElement implements TEALBModuloOpcode {

  public TEALBModuloOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBModuloOpcode(this);
  }
