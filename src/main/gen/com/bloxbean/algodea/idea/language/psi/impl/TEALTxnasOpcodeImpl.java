...
public class TEALTxnasOpcodeImpl extends ASTWrapperPsiElement implements TEALTxnasOpcode {

  public TEALTxnasOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitTxnasOpcode(this);
  }
