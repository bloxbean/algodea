...
public class TEALBTimesOpcodeImpl extends ASTWrapperPsiElement implements TEALBTimesOpcode {

  public TEALBTimesOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBTimesOpcode(this);
  }
