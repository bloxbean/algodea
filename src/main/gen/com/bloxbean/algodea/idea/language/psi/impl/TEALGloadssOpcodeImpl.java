...
public class TEALGloadssOpcodeImpl extends ASTWrapperPsiElement implements TEALGloadssOpcode {

  public TEALGloadssOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGloadssOpcode(this);
  }
