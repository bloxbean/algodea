...
public class TEALGtxnsaOpcodeImpl extends ASTWrapperPsiElement implements TEALGtxnsaOpcode {

  public TEALGtxnsaOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnsaOpcode(this);
  }
