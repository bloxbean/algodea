...
public class TEALExpwOpcodeImpl extends ASTWrapperPsiElement implements TEALExpwOpcode {

  public TEALExpwOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExpwOpcode(this);
  }
