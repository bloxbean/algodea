...
public class TEALBGreaterThanEqOpcodeImpl extends ASTWrapperPsiElement implements TEALBGreaterThanEqOpcode {

  public TEALBGreaterThanEqOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBGreaterThanEqOpcode(this);
  }
