...
public class TEALGloadOperationImpl extends ASTWrapperPsiElement implements TEALGloadOperation {

  public TEALGloadOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGloadOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALGloadOpcode getGloadOpcode() {
    return findNotNullChildByClass(TEALGloadOpcode.class);
  }
