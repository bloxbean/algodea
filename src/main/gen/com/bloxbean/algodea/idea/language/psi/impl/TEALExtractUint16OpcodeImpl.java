...
public class TEALExtractUint16OpcodeImpl extends ASTWrapperPsiElement implements TEALExtractUint16Opcode {

  public TEALExtractUint16OpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExtractUint16Opcode(this);
  }
