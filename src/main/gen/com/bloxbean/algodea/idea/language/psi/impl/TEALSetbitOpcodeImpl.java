...
public class TEALSetbitOpcodeImpl extends ASTWrapperPsiElement implements TEALSetbitOpcode {

  public TEALSetbitOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitSetbitOpcode(this);
  }
