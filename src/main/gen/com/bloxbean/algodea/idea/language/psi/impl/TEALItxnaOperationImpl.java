...
public class TEALItxnaOperationImpl extends ASTWrapperPsiElement implements TEALItxnaOperation {

  public TEALItxnaOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnaOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALItxnaOpcode getItxnaOpcode() {
    return findNotNullChildByClass(TEALItxnaOpcode.class);
  }
