...
public class TEALStoresOpcodeImpl extends ASTWrapperPsiElement implements TEALStoresOpcode {

  public TEALStoresOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitStoresOpcode(this);
  }
