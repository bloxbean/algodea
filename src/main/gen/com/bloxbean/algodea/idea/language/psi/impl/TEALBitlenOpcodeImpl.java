...
public class TEALBitlenOpcodeImpl extends ASTWrapperPsiElement implements TEALBitlenOpcode {

  public TEALBitlenOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBitlenOpcode(this);
  }
