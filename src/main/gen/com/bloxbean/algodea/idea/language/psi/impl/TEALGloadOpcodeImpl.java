...
public class TEALGloadOpcodeImpl extends ASTWrapperPsiElement implements TEALGloadOpcode {

  public TEALGloadOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGloadOpcode(this);
  }
