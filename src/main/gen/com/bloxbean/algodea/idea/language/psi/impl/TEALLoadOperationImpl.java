...
public class TEALLoadOperationImpl extends ASTWrapperPsiElement implements TEALLoadOperation {

  public TEALLoadOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitLoadOperation(this);
  }
