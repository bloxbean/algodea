...
public class TEALGitxnOperationImpl extends ASTWrapperPsiElement implements TEALGitxnOperation {

  public TEALGitxnOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGitxnOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALGitxnOpcode getGitxnOpcode() {
    return findNotNullChildByClass(TEALGitxnOpcode.class);
  }
