...
public class TEALUncoverOpcodeImpl extends ASTWrapperPsiElement implements TEALUncoverOpcode {

  public TEALUncoverOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitUncoverOpcode(this);
  }
