...
public class TEALBDivOpcodeImpl extends ASTWrapperPsiElement implements TEALBDivOpcode {

  public TEALBDivOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBDivOpcode(this);
  }
