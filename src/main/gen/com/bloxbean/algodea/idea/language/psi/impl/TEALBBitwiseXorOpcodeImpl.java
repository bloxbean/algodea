...
public class TEALBBitwiseXorOpcodeImpl extends ASTWrapperPsiElement implements TEALBBitwiseXorOpcode {

  public TEALBBitwiseXorOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBBitwiseXorOpcode(this);
  }
