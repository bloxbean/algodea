...
public class TEALStoreOperationImpl extends ASTWrapperPsiElement implements TEALStoreOperation {

  public TEALStoreOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitStoreOperation(this);
  }
