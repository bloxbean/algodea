...
public class TEALPragmaImpl extends ASTWrapperPsiElement implements TEALPragma {

  public TEALPragmaImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TEALPragmaVersion getPragmaVersion() {
    return findChildByClass(TEALPragmaVersion.class);
  }
