...
public class TEALItxnaOpcodeImpl extends ASTWrapperPsiElement implements TEALItxnaOpcode {

  public TEALItxnaOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnaOpcode(this);
  }
