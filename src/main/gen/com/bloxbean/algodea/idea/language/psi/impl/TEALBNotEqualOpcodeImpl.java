...
public class TEALBNotEqualOpcodeImpl extends ASTWrapperPsiElement implements TEALBNotEqualOpcode {

  public TEALBNotEqualOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBNotEqualOpcode(this);
  }
