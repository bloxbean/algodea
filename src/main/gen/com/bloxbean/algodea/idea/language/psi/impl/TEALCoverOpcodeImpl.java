...
public class TEALCoverOpcodeImpl extends ASTWrapperPsiElement implements TEALCoverOpcode {

  public TEALCoverOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitCoverOpcode(this);
  }
