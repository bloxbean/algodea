...
public class TEALPushByteOpcodeImpl extends ASTWrapperPsiElement implements TEALPushByteOpcode {

  public TEALPushByteOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitPushByteOpcode(this);
  }
