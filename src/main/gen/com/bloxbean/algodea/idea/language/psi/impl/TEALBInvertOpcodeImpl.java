...
public class TEALBInvertOpcodeImpl extends ASTWrapperPsiElement implements TEALBInvertOpcode {

  public TEALBInvertOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBInvertOpcode(this);
  }
