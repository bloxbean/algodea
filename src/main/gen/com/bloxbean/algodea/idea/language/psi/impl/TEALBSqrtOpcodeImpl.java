...
public class TEALBSqrtOpcodeImpl extends ASTWrapperPsiElement implements TEALBSqrtOpcode {

  public TEALBSqrtOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBSqrtOpcode(this);
  }
