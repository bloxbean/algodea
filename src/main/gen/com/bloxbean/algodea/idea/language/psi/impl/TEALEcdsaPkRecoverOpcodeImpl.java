...
public class TEALEcdsaPkRecoverOpcodeImpl extends ASTWrapperPsiElement implements TEALEcdsaPkRecoverOpcode {

  public TEALEcdsaPkRecoverOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitEcdsaPkRecoverOpcode(this);
  }
