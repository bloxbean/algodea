...
public class TEALGloadsOpcodeImpl extends ASTWrapperPsiElement implements TEALGloadsOpcode {

  public TEALGloadsOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGloadsOpcode(this);
  }
