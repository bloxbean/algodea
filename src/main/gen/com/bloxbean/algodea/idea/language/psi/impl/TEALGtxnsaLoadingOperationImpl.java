...
public class TEALGtxnsaLoadingOperationImpl extends ASTWrapperPsiElement implements TEALGtxnsaLoadingOperation {

  public TEALGtxnsaLoadingOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnsaLoadingOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALGtxnsaOpcode getGtxnsaOpcode() {
    return findNotNullChildByClass(TEALGtxnsaOpcode.class);
  }
