...
public class TEALDigOperationImpl extends ASTWrapperPsiElement implements TEALDigOperation {

  public TEALDigOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitDigOperation(this);
  }
