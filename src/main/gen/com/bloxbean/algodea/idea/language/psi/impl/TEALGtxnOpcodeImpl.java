...
public class TEALGtxnOpcodeImpl extends ASTWrapperPsiElement implements TEALGtxnOpcode {

  public TEALGtxnOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnOpcode(this);
  }
