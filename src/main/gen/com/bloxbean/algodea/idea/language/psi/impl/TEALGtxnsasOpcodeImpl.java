...
public class TEALGtxnsasOpcodeImpl extends ASTWrapperPsiElement implements TEALGtxnsasOpcode {

  public TEALGtxnsasOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnsasOpcode(this);
  }
