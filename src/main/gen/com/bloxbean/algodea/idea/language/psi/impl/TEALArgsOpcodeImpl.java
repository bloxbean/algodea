...
public class TEALArgsOpcodeImpl extends ASTWrapperPsiElement implements TEALArgsOpcode {

  public TEALArgsOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitArgsOpcode(this);
  }
