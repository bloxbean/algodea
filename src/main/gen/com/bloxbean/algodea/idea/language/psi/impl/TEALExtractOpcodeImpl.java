...
public class TEALExtractOpcodeImpl extends ASTWrapperPsiElement implements TEALExtractOpcode {

  public TEALExtractOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExtractOpcode(this);
  }
