...
public class TEALDivmodwOpcodeImpl extends ASTWrapperPsiElement implements TEALDivmodwOpcode {

  public TEALDivmodwOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitDivmodwOpcode(this);
  }
