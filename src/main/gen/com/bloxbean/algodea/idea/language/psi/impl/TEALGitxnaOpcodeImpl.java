...
public class TEALGitxnaOpcodeImpl extends ASTWrapperPsiElement implements TEALGitxnaOpcode {

  public TEALGitxnaOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGitxnaOpcode(this);
  }
