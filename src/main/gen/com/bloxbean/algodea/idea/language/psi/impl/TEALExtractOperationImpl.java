...
public class TEALExtractOperationImpl extends ASTWrapperPsiElement implements TEALExtractOperation {

  public TEALExtractOperationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TEALExtractOpcode getExtractOpcode() {
    return findNotNullChildByClass(TEALExtractOpcode.class);
  }
