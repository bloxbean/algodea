...
public class TEALGitxnasOpcodeImpl extends ASTWrapperPsiElement implements TEALGitxnasOpcode {

  public TEALGitxnasOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGitxnasOpcode(this);
  }
