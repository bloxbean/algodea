...
public class TEALGitxnOpcodeImpl extends ASTWrapperPsiElement implements TEALGitxnOpcode {

  public TEALGitxnOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGitxnOpcode(this);
  }
