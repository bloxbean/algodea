...
public class TEALSqrtOpcodeImpl extends ASTWrapperPsiElement implements TEALSqrtOpcode {

  public TEALSqrtOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitSqrtOpcode(this);
  }
