...
public class TEALAcctParamsGetOperationImpl extends ASTWrapperPsiElement implements TEALAcctParamsGetOperation {

  public TEALAcctParamsGetOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitAcctParamsGetOperation(this);
  }
  ...
  @Override
  @NotNull
  public TEALAcctParamsGetOp getAcctParamsGetOp() {
    return findNotNullChildByClass(TEALAcctParamsGetOp.class);
  }
  ...
  @Override
  @Nullable
  public PsiElement getAcctParamsGetField() {
    return findChildByType(ACCT_PARAMS_GET_FIELD);
  }
