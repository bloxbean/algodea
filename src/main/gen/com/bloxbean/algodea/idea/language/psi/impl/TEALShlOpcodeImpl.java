...
public class TEALShlOpcodeImpl extends ASTWrapperPsiElement implements TEALShlOpcode {

  public TEALShlOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitShlOpcode(this);
  }
