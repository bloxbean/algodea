...
public class TEALSetbyteOpcodeImpl extends ASTWrapperPsiElement implements TEALSetbyteOpcode {

  public TEALSetbyteOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitSetbyteOpcode(this);
  }
