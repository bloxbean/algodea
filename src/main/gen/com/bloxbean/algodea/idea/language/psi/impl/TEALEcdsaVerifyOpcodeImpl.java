...
public class TEALEcdsaVerifyOpcodeImpl extends ASTWrapperPsiElement implements TEALEcdsaVerifyOpcode {

  public TEALEcdsaVerifyOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitEcdsaVerifyOpcode(this);
  }
