...
public class TEALPushIntOpcodeImpl extends ASTWrapperPsiElement implements TEALPushIntOpcode {

  public TEALPushIntOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitPushIntOpcode(this);
  }
