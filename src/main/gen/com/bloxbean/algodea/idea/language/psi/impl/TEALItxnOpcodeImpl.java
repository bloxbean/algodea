...
public class TEALItxnOpcodeImpl extends ASTWrapperPsiElement implements TEALItxnOpcode {

  public TEALItxnOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitItxnOpcode(this);
  }
