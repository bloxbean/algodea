...
public class TEALBLessThanEqOpcodeImpl extends ASTWrapperPsiElement implements TEALBLessThanEqOpcode {

  public TEALBLessThanEqOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBLessThanEqOpcode(this);
  }
