...
public class TEALBBitwiseAndOpcodeImpl extends ASTWrapperPsiElement implements TEALBBitwiseAndOpcode {

  public TEALBBitwiseAndOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBBitwiseAndOpcode(this);
  }
