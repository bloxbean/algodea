...
public class TEALGtxnsOpcodeImpl extends ASTWrapperPsiElement implements TEALGtxnsOpcode {

  public TEALGtxnsOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitGtxnsOpcode(this);
  }
