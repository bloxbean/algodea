...
public class TEALBLessThanOpcodeImpl extends ASTWrapperPsiElement implements TEALBLessThanOpcode {

  public TEALBLessThanOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBLessThanOpcode(this);
  }
