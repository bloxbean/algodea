...
public class TEALExtract3OpcodeImpl extends ASTWrapperPsiElement implements TEALExtract3Opcode {

  public TEALExtract3OpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExtract3Opcode(this);
  }
