...
public class TEALBEqualOpcodeImpl extends ASTWrapperPsiElement implements TEALBEqualOpcode {

  public TEALBEqualOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBEqualOpcode(this);
  }
