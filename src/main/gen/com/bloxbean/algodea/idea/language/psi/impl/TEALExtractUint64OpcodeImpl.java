...
public class TEALExtractUint64OpcodeImpl extends ASTWrapperPsiElement implements TEALExtractUint64Opcode {

  public TEALExtractUint64OpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitExtractUint64Opcode(this);
  }
