...
public class TEALBPlusOpcodeImpl extends ASTWrapperPsiElement implements TEALBPlusOpcode {

  public TEALBPlusOpcodeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitBPlusOpcode(this);
  }
