...
public class TEALIntcblockOperationImpl extends ASTWrapperPsiElement implements TEALIntcblockOperation {

  public TEALIntcblockOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitIntcblockOperation(this);
  }
