...
public class TEALIntcOperationImpl extends ASTWrapperPsiElement implements TEALIntcOperation {

  public TEALIntcOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TEALVisitor visitor) {
    visitor.visitIntcOperation(this);
  }
